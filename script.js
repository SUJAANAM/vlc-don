...
// const toast=document.querySelector("video")
...
// videoBtn.addEventListener("click",handleInput);
// videoInput.addEventListener("click",handleInput)
// videoInput.addEventListener("change",acceptInputHandler)
// const speedUpHandler = () => {
...
//   // Set the playback speed to 1.0x if it hasn't been set yet
  
//    const increaseSpeed= videoElement.playbackRate+0.25;
//    console.log("increaseSpeed",increaseSpeed);
//    videoElement.playbackRate=increaseSpeed
...
//   // Set the playback speed to 1.0x if it hasn't beendeet yet
